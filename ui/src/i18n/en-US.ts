export default {
  ...
  settings: {
    ...
    validationHint: "Probes each language's language-server executable (e.g. gopls, rust-analyzer), not the language toolchain itself; toolchain readiness is shown on the right of each row. An empty command override means auto-detect; when a server is missing you can install it from this row.",
    ...
    lspServerMissing: "Language server not installed",
    lspServerMissingNoSdk: "Language server not installed ({{name}} not found)",
    lspSdkReady: "{{name}} ready", lspSdkMissing: "{{name}} not found",
    lspInstall: "Install", lspInstallDone: "Installed", lspInstallFailed: "Install failed",
    lspNeedRuntime: "Requires {{name}} first", lspDownload: "Download", lspManualInstall: "Manual install",
