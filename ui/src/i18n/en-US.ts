export default {
  goal: {
    contract: "Goal and acceptance contract for approval",
    automatic: "Automated verification",
    defaultCwd: "Use the session's default command directory",
    permission: "Execution permissions match full access",
    budgetRequired: "Choose a budget or explicitly select no limit before starting",
    configureBudget: "Set goal budget",
    saveBudget: "Confirm budget",
    limited: "Set limits",
    unlimited: "No limit",
    tokenLimit: "Total token limit (optional)",
    timeLimit: "Total execution minutes (optional)",
    budgetSummary: "Budget: {{tokens}} tokens / {{minutes}} minutes (— means unlimited)",
    budgetHint: "Set at least one limit. Usage includes the main agent, subagents, reviews and compaction across resumptions. Pauses and manual acceptance do not count toward execution time. Reaching either limit stops new work; in-flight requests may add usage. To add budget, enter a new cumulative limit.",
    usage: "Total usage: {{tokens}} tokens · {{minutes}} minutes",
    pausedHint: "Sending additional information keeps the goal paused. Select Resume to continue execution.",
    stoppingHint: "Waiting for tools and subagents to exit. The goal is not yet paused.",
    acceptanceHint: "Check the evidence and complete manual verification. Submit any issues, then select Resume to repair them.",
    accept: "Confirm acceptance",
    feedbackPlaceholder: "Describe failed acceptance criteria and observed behavior",
    feedback: "Submit feedback and keep paused",
    pending: "Remaining work",
    blocked: "Blockers and recovery conditions",
    sources: "Requirements and design sources",
    baseline: "Initial checks",
    evidence: "Acceptance evidence",
    verifications: "Verification records",
    review: "Independent review",
    manual: "Manual acceptance required",
  },
  ...
  composer: {
    ...
    modeGoal: "Goal mode",
    modeGoalDesc: "Full access with autonomous delivery and verification",
    ...
    goalBannerClarify: "Confirm the goal, acceptance criteria and budget, then proceed with full access",
    goalRunning: "{{n}} rounds completed",
    goalResume: "Resume",
    goalReviewDelivery: "Review delivery",
    ...
    goalStatusStopping: "Stopping",
    goalStatusAwaitingAcceptance: "Awaiting your acceptance",
