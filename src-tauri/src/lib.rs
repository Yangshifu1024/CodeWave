...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            host::commands::mcp_connect,
            host::commands::mcp_disconnect,
            host::commands::mcp_reconnect,
            host::commands::mcp_test,
            host::commands::mcp_snapshot,
            ...
            host::commands::update_scheduled_task,
            host::commands::set_scheduled_task_enabled,
            host::commands::run_scheduled_task_now,
